...
void main() {
  ...
  final tTVEpisodeModelList = [tTVEpisodeModel];
  final tTVEpisodeList = [tTVEpisode];
  ...
  group('Get TV Detail', () {
    ...
    final tTVResponse = TVDetailResponse(
      backdropPath: "/1qpUk27LVI9UoTS7S0EixUBj5aR.jpg",
      firstAirDate: "2022-03-24",
      genres: [GenreModel(id: 10759, name: "Action & Adventure"), GenreModel(id: 10765, name: "Sci-Fi & Fantasy")],
      id: 52814,
      name: "Halo",
      originalName: "Halo",
      overview: "Depicting an epic 26th-century conflict between humanity and an alien threat known as the Covenant, the series weaves deeply drawn personal stories with action, adventure and a richly imagined vision of the future.",
  ...
  group('TV Episode', () {
    ...
    test('should return TV episode list when call to data source is successful',
            () async {
          // arrange
          when(mockRemoteDataSource.getTVEpisode(idTV, seasonNumber))
              .thenAnswer((_) async => tTVEpisodeModelList);
          // act
          final result = await repository.getTVEpisode(idTV, seasonNumber);
          // assert
          /* workaround to test List in Right. Issue: https://github.com/spebbe/dartz/issues/80 */
          final resultList = result.getOrElse(() => []);
          expect(resultList, tTVEpisodeList);
        });
